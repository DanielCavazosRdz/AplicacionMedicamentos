 ...
 * @author Daniel
 */
@WebServlet(name = "NewUsuario", urlPatterns = {"/NewUsuario"})
public class NewUsuario extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet NewUsuario at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        uo.addUsuario(request.getParameter("nombre"), request.getParameter("pass"), rol);
